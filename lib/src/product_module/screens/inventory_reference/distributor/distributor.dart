...
class InventoryDistributor extends StatefulWidget {
  static const routeName = '/InventoryDistributor';
  const InventoryDistributor({super.key});

  @override
  State<InventoryDistributor> createState() => _InventoryDistributorState();
}

class _InventoryDistributorState extends State<InventoryDistributor>
  ...
  list(page, limit) async {
    ...
    distributor = await InventoryApi()
        .distributorList(ResultArguments(offset: offset, filter: filter));
    groupMaker();
    setState(() {
      isLoading = false;
    });
