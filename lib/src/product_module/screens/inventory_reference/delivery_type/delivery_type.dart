...
class InventoryDeliveryType extends StatefulWidget {
  static const routeName = '/InventoryDeliveryType';
  const InventoryDeliveryType({super.key});

  @override
  State<InventoryDeliveryType> createState() => _InventoryDeliveryTypeState();
}

class _InventoryDeliveryTypeState extends State<InventoryDeliveryType>
  ...
  list(page, limit) async {
    ...
    distributor = await InventoryApi()
        .deliveryTypeList(ResultArguments(offset: offset, filter: filter));
    groupMaker();
    setState(() {
      isLoading = false;
    });
