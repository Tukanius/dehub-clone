...
class _UnitSheetState extends State<UnitSheet> with AfterLayoutMixin {
  TextEditingController controller = TextEditingController();
  GlobalKey<FormBuilderState> fbKey = GlobalKey<FormBuilderState>();
  bool isLoading = true;
  Result unit = Result(count: 0, rows: []);
  ...
  create() async {
    ...
    var res = await InventoryApi().unitCreate(create);
    setState(() {
      unit.rows?.add(res);
    });
  }
  ...
  update(String id) async {
    if (fbKey.currentState!.saveAndValidate()) {
      ...
      try {
        await InventoryApi().unitUpdate(id, data);
        await unitList();
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      await InventoryApi().unitDelete(id);
                      await unitList();
