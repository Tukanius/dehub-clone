...
class _SupplierSheetState extends State<SupplierSheet> with AfterLayoutMixin {
  ...
  bool isLoading = true;
  Result supplier = Result(count: 0, rows: []);
  ...
  supplierList() async {
    supplier = await InventoryApi().supplierList();
    setState(() {
      isLoading = false;
    });
  }
  ...
  create() async {
    ...
    var res = await InventoryApi().supplierCreate(create);
    setState(() {
      supplier.rows?.add(res);
    });
  }
  ...
  update(String id) async {
    if (fbKey.currentState!.saveAndValidate()) {
      ...
      try {
        await InventoryApi().supplierUpdate(id, data);
        await supplierList();
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      await InventoryApi().supplierDelete(id);
                      await supplierList();
