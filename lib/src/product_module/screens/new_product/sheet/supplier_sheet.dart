...
class _SupplierSheetState extends State<SupplierSheet> with AfterLayoutMixin {
  ...
  afterFirstLayout(BuildContext context) async {
    supplierList(page, limit);
  }

  supplierList(page, limit) async {
    list = await InventoryApi().supplierList();
    setState(() {
      isLoading = false;
    });
  }
  ...
  create() async {
    ...
    await InventoryApi().supplierCreate(create);
  }
