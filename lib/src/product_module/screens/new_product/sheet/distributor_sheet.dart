...
class DistributorSheet extends StatefulWidget {
  const DistributorSheet({super.key});

  @override
  State<DistributorSheet> createState() => _DistributorSheetState();
}

class _DistributorSheetState extends State<DistributorSheet>
    with AfterLayoutMixin {
  TextEditingController controller = TextEditingController();
  GlobalKey<FormBuilderState> fbKey = GlobalKey<FormBuilderState>();
  bool isLoading = true;
  Result distributor = Result(count: 0, rows: []);
  ...
  create() async {
    ...
    var res = await InventoryApi().distributorCreate(create);
    setState(() {
      distributor.rows?.add(res);
    });
  }
  ...
  update(String id) async {
    if (fbKey.currentState!.saveAndValidate()) {
      ...
      try {
        await InventoryApi().distributorUpdate(id, data);
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      await InventoryApi().distributorDelete(id);
                      await distributorList();
