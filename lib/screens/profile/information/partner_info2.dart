...
class PartnerInfo2 extends StatefulWidget {
  static const routeName = '/partnerinfo2';
  const PartnerInfo2({super.key});

  @override
  State<PartnerInfo2> createState() => _PartnerInfoState();
}

class _PartnerInfoState extends State<PartnerInfo2> {
  int percent = 0;
  @override
