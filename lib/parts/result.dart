...
Map<String, dynamic> _$ResultArgumentToJson(ResultArguments? instance) {
  ...
  if (instance != null) {
    ...
    if (instance.filter!.receiverBusinessId != null) {
      params['filter']['receiverBusinessId'] =
          instance.filter!.receiverBusinessId;
    }
    if (instance.filter!.isDropshipping != null) {
      params['filter']['isDropshipping'] = instance.filter!.isDropshipping;
    }
    if (instance.filter!.orderStatus != null) {
      params['filter']['orderStatus'] = instance.filter!.orderStatus;
    }
    if (instance.filter!.settlementId != null) {
      params['filter']['settlementId'] = instance.filter!.settlementId;
    }
    if (instance.filter!.userId != null) {
      params['filter']['userId'] = instance.filter!.userId;
    }
    ...
    if (instance.filter!.variantId != null) {
      params['filter']['variantId'] = instance.filter!.variantId;
    }
