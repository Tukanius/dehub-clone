part of '../models/client_classification.dart';

ClientClassifications _$ClientClassificationsFromJson(
    Map<String, dynamic> json) {
  return ClientClassifications(
    id: json['id'] != null ? json['id'] as String : null,
    createdAt: json['createdAt'] != null ? json['id'] as String : null,
...
Map<String, dynamic> _$ClientClassificationsToJson(
    ClientClassifications instance) {
  Map<String, dynamic> json = {};
